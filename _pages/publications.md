...
- Guoyu Kang, Ruotian Wang, Yan Xu, and Dan Yang (2026) <br> Concealed Skewness: Extracting Global and Country-specific Components of Currency Excess Returns.

- Rong Chen, Yuefeng Han, Zebang Li, Han Xiao, Dan Yang, Ruofan Yu (2025) <br> Analysis of Tensor Time Series: tensorTS.
...
## Publications:
--------------
- Junhui Cai, Dan Yang, Ran Chen, Wu Zhu, Haipeng Shen and Linda Zhao (2026) <br>
Network Regression and Supervised Centrality Estimation. <br> Journal of the American Statistical Association, 121(554), 1269–1283. [[SSRN]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3963523)

- Dan Yang, Jianlong Shao, Haipeng Shen, and Hongtu Zhu (2026) <br> Optimal functional bilinear regression with matrix covariates via reproducing kernel Hilbert space. <br> Journal of Machine Learning Research, 26(270):1−52. [[Arxiv]](http://arxiv.org/abs/2311.12597)
...
- Xin Chen, Dan Yang, Yan Xu, Yin Xia, Dong Wang, and Haipeng Shen (2023) <br> Testing and Support Recovery of Correlation Structures for Matrix-Valued Observations with an Application to Stock Market Data. <br> Journal of Econometrics, 232(2), 544-564. [[SSRN]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3950370)
...
- Rong Chen, Dan Yang, and Cun-Hui Zhang (2022) <br> Factor models for high-dimensional tensor time series (with discussion). <br> Journal of the American Statistical Association, Vol.117 (537), p.94-116. [[SSRN]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5633370)

- Rong Chen, Han Xiao, and Dan Yang (2021) <br> Autoregressive models for matrix-valued time series. <br> Journal of Econometrics, 222(1):539-560. [[SSRN]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5633310)

- Lutao Dai, Dan Yang, Haipeng Shen (2020). <br> The Power of Clinical Data Empowered by Clinical Prediction Model, <br> Annals of Translational Medicine, 8, 1-4.
